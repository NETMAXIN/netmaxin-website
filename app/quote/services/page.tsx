...
function ServiceQuoteForm() {
    ...
    useEffect(() => {
        if (selectedService && servicesList.includes(selectedService)) {
    ...
    return (
        <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-2xl border border-black/5 dark:border-white/5 p-8 rounded-3xl shadow-xl max-w-2xl mx-auto mt-8 mb-16">
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    <label className="block text-sm font-semibold mb-2 text-foreground dark:text-white">Select Service *</label>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-6">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif text-balance mb-6 leading-tight">
                            Request a Quote for <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-cyan-600 dark:from-emerald-400 dark:to-cyan-400 font-bold">Services</span>
                        </h1>
